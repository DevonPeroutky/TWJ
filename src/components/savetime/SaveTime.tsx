...
import "./savetime.css";
import TWJBadge from "../../assets/TWJbadge.png";
...
export const SaveTime = (props: {}) => (
  <div className="save-time">
    ...
    <div className="icon-row">
      ...
      <BadgeItem title="We are certified in special needs travel!" description="We are trained and certified to best prepare for those needing special diets, on the autism spectrum, needing low-sensory environments, in a wheelchair, with a service dog, or needing allergy friendly accommodations." />
...
const BadgeItem = (props: {title: string, description: string}) => (
  <div className="icon-item">
    <img src={TWJBadge} height="100" width="100"/>
    <div className="i-title">{props.title}</div>
    <div className="description">{props.description}</div>
  </div>
)
